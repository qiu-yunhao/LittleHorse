...
public class ChooseActivity2 extends AppCompatActivity {
    ...
    private String[] ss=new String[]{"choose_pingpong","choose_left"};

    //private String needToChoose="banana";
    private String[] needToChoose2=new String[]{"clock","below"};
                        ...
                        if(option==""){
                            ...
                            for(int i=0;i<ss.length;i++){
                                ...
                                if (s.equals(json)){
                                    ...
                                    //"pic" 可以作为json文件名称
                                    GameType gameType = new GameType("语义游戏", option,json,s,needToChoose2[i]);
